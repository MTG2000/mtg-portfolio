...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  const result = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/user/login", {
    username,
    password
  });
  const {
  ...
  res.setHeader("Set-Cookie", Object(cookie__WEBPACK_IMPORTED_MODULE_1__["serialize"])("accessToken", token, {
    path: "/",
    maxAge: 1800
  }));
  res.send({
